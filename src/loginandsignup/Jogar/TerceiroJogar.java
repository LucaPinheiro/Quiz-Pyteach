...
public class TerceiroJogar extends javax.swing.JFrame {

    private String respostaCorreta;
    private String alternativaCorreta;
    private JRadioButton[] botoes;

    public TerceiroJogar() {
        initComponents();
        setaPergunta();
        setaContador();
    ...
    private void initComponents() {
        ...
        ContTF3 = new javax.swing.JTextField();
        ...
        QF3.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        QF3.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 51, 153), null));
        QF3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                QF3ActionPerformed(evt);
            }
        });
        ...
        ContTF3.setEditable(false);
        ContTF3.setBackground(new java.awt.Color(0, 102, 153));
        ContTF3.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 60)); // NOI18N
        ContTF3.setBorder(null);
        ContTF3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ContTF3ActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(ContTF3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(ContTF3, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(QF3, javax.swing.GroupLayout.PREFERRED_SIZE, 767, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(QF3, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void QF3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_QF3ActionPerformed

    }//GEN-LAST:event_QF3ActionPerformed
    ...
    private void NextQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextQuestionActionPerformed
        ...
        if (selectedButton != null && selectedButton.getText().equals(respostaCorreta)) {
            ...
            Contadores.ContadorTentativaF3++;
            Contadores.ContadorAcertoF3++;
        } else {
        ...
        if (Contadores.ContadorTentativaF3 == 3) {
            if (Contadores.ContadorAcertoF3 >= 2) {
                QuartoJogar q = new QuartoJogar();
                q.setVisible(true);
                q.pack();
                q.setLocationRelativeTo(null);
                this.dispose();
            } else if (Contadores.ContadorAcertoF3 < 2) {
                Contadores.zeraContadores();
                Contadores.ContadorTentativaF3 = 0;
    ...
    private void ContTF3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ContTF3ActionPerformed
    }//GEN-LAST:event_ContTF3ActionPerformed
    ...
    public final void setaPergunta() {
        ...
        // Escolher 3 perguntas aleatórias para as questões da fase 3 
    ...
    public final void setaContador() {
        String contadorTentativaF3String = Integer.toString(Contadores.ContadorTentativaF3 + 1);
        ContTF3.setText(contadorTentativaF3String + ".");
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField ContTF3;
